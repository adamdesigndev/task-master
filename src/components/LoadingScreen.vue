...
onMounted(() => {
  ...
  }, 2800); // Adjust this time to match the animation duration
});
</script>
...
.fade-enter-active, .fade-leave-active {
  transition: opacity .5s ease; /* 3 seconds for fade-out animation */
}
...
@keyframes animateSquare {
  0% {
    stroke-dasharray: 0 186; /* Length of the path */
    stroke-dashoffset: 0;
  }
  100% {
...
#square-outline {
  ...
  animation: animateSquare 3s 0.5s ease forwards; /* Extend the square animation to 3 seconds and add a 0.5s delay */
}
